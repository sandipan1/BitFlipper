...
def train(env,save_path):
  ...
  act = deepq.learn(env,q_func=a,lr=1e-3,max_timesteps=80000*env.n,buffer_size=1000000,exploration_fraction=0.05,
      exploration_final_eps=0.005,train_freq=1,batch_size=128,gamma=0.99,
